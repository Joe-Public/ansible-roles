...
- **hass_bluetooth**: Enables bluetooth support for Raspberry Pis (e.g. for [EQ3 Bluetooth thermostat](https://www.home-assistant.io/components/climate.eq3btsmart/)). By default it is disabled (`false`).
